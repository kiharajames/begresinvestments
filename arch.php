...
<head>
	<title>Architectural and engineering design | Begres Investments</title>
				...
				<div class="row">
					<div class="col-md-3 col-sm-6">
						<div class="services-post">
							...
							<h2>Clean &amp; Modern <br> Design</h2>
						</div>
					</div>
					<div class="col-md-3 col-sm-6">
						<div class="services-post">
							<a href="#"><i class="fa fa-wrench"></i></a>
							<h2>Trusted Expert <br> Support</h2>
						</div>
					</div>
					<div class="col-md-3 col-sm-6">
						<div class="services-post">
							<a href="#"><i class="fa fa-cog"></i></a>
							<h2>Easy To <br> Customize</h2>
						</div>
					</div>
					<div class="col-md-3 col-sm-6">
						<div class="services-post">
							<a href="#"><i class="fa fa-heart-o"></i></a>
							<h2>Crafted <br>With Love</h2>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="feature-post">
										<span>01</span>
										<h2>Concepts &amp; <br> Brainstorming</h2>
								...
								<div class="col-md-6">
									<div class="feature-post">
										<span>03</span>
										<h2>Sketching &amp; <br>Drafting</h2>
										<p>Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. Sed arcu.
											Cras consequat.</p>
									</div>
									<div class="feature-post">
										<span>04</span>
										<h2>Execution &amp; <br>Digitalisation</h2>
										<p>Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. Sed arcu.
											Cras consequat.</p>
									</div>
								</div>
